        ...
        <header className="flex flex-col items-center gap-3 justify-center text-indigo-900 mb-8">
            ...
            <div className="flex flex-row gap-4 justify-between items-center md:w-3/4 px-4">
                <div className="flex flex-row gap-2 text-indigo-800">
                    <a href='https://youtube.com/playlist?list=PLQN6TAdsJwp6jIWEOCZCCzx84ik8SdQo1&si=OOCz9eoUXgnLKuQo' className='h-8 w-8 flex flex-row items-center justify-center'>
                    ...
                    <a href='https://www.instagram.com/esportsconnection/' className='h-8 w-8 flex flex-row items-center justify-center'>
                        <FontAwesomeIcon icon={faInstagram} fixedWidth size='2x' />
                    </a> 

                    <a href='https://www.linkedin.com/company/oc-talk-radio/' className='h-8 w-8 flex flex-row items-center justify-center'>
