...
const Footer = () => {
    return (
        ...
        <Link href="/contact">
        <a target="_blank" rel="noopener noreferrer" className="text-white text-opacity-70 hover:text-opacity-100">Contact</a>
        </Link>
        </li>
        <li className="inline-flex">
        <Link href="/team">
        <a target="_blank" rel="noopener noreferrer" className="text-white text-opacity-70 hover:text-opacity-100">Meet The Team</a>
        </Link>
        </li>
        <li className="inline-flex">
        <Link href="#">
        <a target="_blank" rel="noopener noreferrer" className="text-white text-opacity-70 hover:text-opacity-100">Events</a>
        </Link>
        </li>
        <li className="inline-flex">
        <Link href="/advertise">
        <a target="_blank" rel="noopener noreferrer" className="text-white text-opacity-70 hover:text-opacity-100">Advertise</a>
        </Link>
        </li>
        </ul>
